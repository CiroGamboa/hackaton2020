...
#%% Leer datasets
'''
Los dataset fueron ligeramente modificados, agregando el nombre de las columnas
'''
# 19 campos
...
#%%
#Esto elimina el primer registro
#app_dataset.columns = ['id','vacant_id','candidate_id','created_at','status','discard_type']
